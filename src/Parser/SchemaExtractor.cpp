...
void SchemaExtractor::create_tables() {
    ...
    for (pugi::xpath_node t : tables) {
        ...
        string get_columns = "/schema/tables/table[table_name=\"" + table_name +
                             "\"]/columns/column";
        pugi::xpath_node_set columns =
            xml_dom.select_nodes(get_columns.c_str());
        ...
        string get_foreign_keys = "/schema/tables/table[table_name=\"" +
                                  table_name + "\"]/foreign_keys/foreign_key";
        pugi::xpath_node_set foreign_keys =
            xml_dom.select_nodes(get_foreign_keys.c_str());
        for (pugi::xpath_node fk : foreign_keys) {
            ...
            string get_column_names = "/schema/tables/table[table_name=\"" +
                                      fk_table +
                                      "\"]/columns/column/column_name";
            pugi::xpath_node_set column_names =
                xml_dom.select_nodes(get_column_names.c_str());
            bool flag = false;
...
void SchemaExtractor::create_projections() {
    ...
    for (pugi::xpath_node p : projections) {
        ...
        string get_base_table =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/tables/base_table";
        pugi::xpath_node base_table_xpath_node =
            xml_dom.select_node(get_base_table.c_str());
        ...
        string get_join_tables =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/tables/join_tables/table";
        pugi::xpath_node_set join_tables =
            xml_dom.select_nodes(get_join_tables.c_str());
        for (pugi::xpath_node j : join_tables) {
            ...
            get_column_names = "/schema/tables/table[table_name=\"" + fk_table +
                               "\"]/columns/column/column_name";
        ...
        string get_columns =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/columns/column";
        pugi::xpath_node_set columns =
            xml_dom.select_nodes(get_columns.c_str());
        for (pugi::xpath_node c : columns) {
            pugi::xml_node column = c.node();
            ...
            if (flag) {
                ...
                new_projection.add_column(name, table_name, column_name,
                                          encoding, data_type);
            } else {
                string to_throw = "";
                to_throw += "Attribute ";
        ...
        string get_sort_key =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/sort_key";
        pugi::xpath_node sort_key_xpath_node =
            xml_dom.select_node(get_sort_key.c_str());
        ...
        string get_column_names =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/columns/column/name";
        pugi::xpath_node_set column_names =
            xml_dom.select_nodes(get_column_names.c_str());
        for (pugi::xpath_node c : column_names) {
            pugi::xml_node column_name = c.node();
        ...
        string get_join_indexes =
            "/schema/projections/projection[projection_name=\"" +
            projection_name + "\"]/join_indexes/join_index";
        pugi::xpath_node_set join_indexes =
            xml_dom.select_nodes(get_join_indexes.c_str());
        for (pugi::xpath_node j : join_indexes) {
            ...
            get_column_names =
                "/schema/projections/projection[projection_name=\"" +
                other_projection + "\"]/columns/column/name";
            column_names = xml_dom.select_nodes(get_column_names.c_str());
            bool flag2 = false;
            for (pugi::xpath_node c : column_names) {
                pugi::xml_node column_name = c.node();
